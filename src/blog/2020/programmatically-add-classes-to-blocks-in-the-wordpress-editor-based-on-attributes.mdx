...
*I am assuming you are familiar with JavaScript (ESNext), React and have an appropriate development environment for your project. If you are not, or need a refresher, check out the [Tutorials](https://developer.wordpress.org/block-editor/tutorials/) in the Block Editor Handbook.*
