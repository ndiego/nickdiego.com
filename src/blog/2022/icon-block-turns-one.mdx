...
<Image src="/images/posts/icon-block-no-fill-toggle.gif" alt="Using a Heroicon SVG with the new toggle fill color option." width={1127} height={826} caption={<>Using a Heroicon SVG with the new toggle fill color option.</>} />
...
<Image src="/images/posts/icon-block-border-spacing.png" alt="Updated border and spacing controls in preparation for WordPress 6.1" width={1049} height={778} caption={<>Updated border and spacing controls in preparation for WordPress 6.1</>} />
...
<Image src="/images/posts/icon-block-title-attribute.png" alt="" width={656} height={530} caption={<>The new title attribute is located in the Advanced panel.</>} />
...
<Image src="/images/posts/icon-block-placeholder.gif" alt="The new placeholder component in the Icon Block." width={860} height={416} caption={<>The new placeholder component in the Icon Block.</>} />
...
<Image src="/images/posts/icon-block-global-styles.gif" alt="Setting border and spacing styles in the Global Styles panel." width={750} height={600} caption={<>How to set border and spacing styles in the Global Styles panel.</>} />
