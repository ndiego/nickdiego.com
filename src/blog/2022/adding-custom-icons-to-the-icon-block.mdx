...
<Image src="/images/blog/icon-block-library-popover.png" alt="Example Icons in the Icon Block quick inserter." width={700} height={600} caption={<>Example Icons in the Quick Inserter</>} />

<Image src="/images/blog/icon-block-library-custom-icons.png" alt="Example Icons in the Icon Block inserter modal." width={1163} height={761} caption={<>Example Icons in the Inserter modal</>} />
