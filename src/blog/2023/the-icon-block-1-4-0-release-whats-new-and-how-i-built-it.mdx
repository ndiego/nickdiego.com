...
<Image src="/images/posts/icon-block-width-units.webp" alt="" width={362} height={376} size="small" />
...
<Image src="/images/posts/icon-block-height.webp" alt="The new height control in version 1.4.0." width={416} height={358} size="small" />
...
<Image src="/images/posts/icon-block-style-switching.gif" alt="" width={1163} height={792} />
...
<Image src="/images/posts/icon-block-dimensions-panel.png" alt="The Dimensions panel for the Group block in Gutenberg 14.8." width={410} height={390} caption={<>The Dimensions panel for the Group block in Gutenberg 14.8.</>} size="small" />
...
<Image src="/images/posts/icon-block-settings-panel.gif" alt="" width={648} height={566} />
