...
<Image
  src="./linked-group.png"
  alt="The Editor view of the Enable Linked Group blocks plugin."
  width={1384}
  height={1056}
/>

<LinkButton
  href="https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/ndiego/enable-linked-groups/main/_playground/blueprint-github.json"
  align="center"
  label="Try the Playground Demo"
/>
...
<Image
  src="./linked-group-image-link.jpg"
  alt="The Image block link control."
  width={1082}
  height={660}
/>
...
<Video id="7fd2e998e9640c34eab4fdbbce26f65e" />
...
If you have suggestions on improving this extension, please reach out at [@nickmdiego](https://x.com/nickmdiego) or consider creating a pull request in the [GitHub repository](https://github.com/ndiego/enable-linked-groups).
