...
After participating in the [AI Speed Build Challenge](https://www.youtube.com/watch?v=vjw6KWahFlk) with Ryan and Jamie yesterday, I got the bug to push the limits of AI—specifically [Cursor](https://www.cursor.com/)—despite my _very_ limited skills in prompting.
...
<Image
  src="./shadcn-theme-switches.png"
  alt="The theme switches on the Shadcn UI website."
  width={1024}
  height={588}
/>
