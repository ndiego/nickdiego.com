...
**Edit: **You can read the complete tutorial on the [WordPress Developer Blog](https://developer.wordpress.org/news/2024/02/29/an-introduction-to-block-based-mega-menus/).