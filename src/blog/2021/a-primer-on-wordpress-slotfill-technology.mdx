...
<Image src="/images/blog/slotfill-pre-1200.jpg" alt="" width={1200} height={756} caption={<>The current settings page before SlotFill is introduced</>} />
...
<Image src="/images/blog/slotfill-post-1200.jpg" alt="SlotFill Example" width={1200} height={1029} caption={<>The settings page after premium functionality has been added via SlotFill</>} />
