...
<Notice type="note">
  Since this article was written, it's now possible to disable responsive
  columns in the Columns block settings. The remaining CSS examples are still
  valid.
</Notice>
...
_Note here that I am using the new “Enable responsive menu” functionality on the Navigation block. _
