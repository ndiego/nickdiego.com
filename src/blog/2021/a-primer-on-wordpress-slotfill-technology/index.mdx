...
<Image
  src="./slotfill-pre-1200.jpg"
  alt=""
  width={1200}
  height={756}
  caption={<>The current settings page before SlotFill is introduced</>}
/>
...
const SettingsComponent = (props) => {
  return (
    <div className="setting-item">
      // Existing setting in main plugin // Existing setting in main plugin
    </div>
  );
};
```
...
<Image
  src="./slotfill-post-1200.jpg"
  alt="SlotFill Example"
  width={1200}
  height={1029}
  caption={
    <>
...
This article will get updated over time with new discoveries and insights. If you have any of your own, please reach out at [@nickmdiego](https://x.com/nickmdiego)!
