...
<Image src="./post-categories-block-inserter.png" alt="" width={1024} height={594} caption={<>The Post Categories block in the block inserter.</>} />
...
<Image src="./block-variation-inserter.webp" alt="" width={1024} height={587} caption={<>The Article Categories block variation in the block inserter.</>} />
