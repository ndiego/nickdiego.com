...
export default function AboutPage() {
  return (
    <div className="max-w-2xl mx-auto px-6 py-12">
      <h1 className="text-[var(--text-heading)] text-3xl font-medium mb-8">About</h1>
      ...
      <div className="space-y-6">
        ...
        <h2 className="text-[var(--text-heading)] text-2xl font-medium mt-10 mb-4">What I do</h2>
        ...
        <h2 className="text-[var(--text-heading)] text-2xl font-medium mt-10 mb-4">Projects</h2>
